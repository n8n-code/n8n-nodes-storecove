...
export class StorecoveApi implements ICredentialType {
	name = 'N8nDevStorecoveApi';

	displayName = 'storecove API';

	icon: Icon = { light: 'file:../nodes/Storecove/storecove.png', dark: 'file:../nodes/Storecove/storecove.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://api.storecove.com/api/v2',
			description: 'The base URL of your storecove API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
